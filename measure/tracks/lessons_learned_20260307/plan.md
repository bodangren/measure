# Implementation Plan: Measure Workflow Memory & Learning Improvements
...
- [x] Task 1.1: Create `lessons-learned.md` template `8cae46a`
    ...
    - [x] Write `claude-skills/measure/assets/lessons-learned.md`
...
- [x] Task 1.2: Create `tech-debt.md` template `8cae46a`
    ...
    - [x] Write `claude-skills/measure/assets/tech-debt.md`
    - [x] Write `templates/tech-debt.md`
    - [x] Verify both copies match the acceptance criteria and remain identical

- [x] Task 1.3: Add context budget checker script `8cae46a`
    - [x] Define acceptance criteria: repository contains a small script that reports line counts for `measure/lessons-learned.md` and `measure/tech-debt.md`, marks each as `OK` or `OVER_LIMIT`, and exits successfully even when files do not yet exist
    - [x] Write `scripts/measure/check_context_budget.sh`
    - [x] Verify the script uses a standard 50-line limit and can be referenced by workflow docs

- [ ] Task 1.4: Measure - User Manual Verification 'Phase 1: New Template Files' (Protocol in workflow.md)
...
- [x] Task 2.1: Add stub creation steps to setup.md (FR-3) `52e2f79`
    ...
    - [x] Edit `claude-skills/measure/references/setup.md` — add the new step after §2.5
...
- [x] Task 2.2: Add index.md entries for new files (FR-3) `52e2f79`
    - [x] Define acceptance criteria
    - [x] Edit `claude-skills/measure/references/setup.md` — add index entries in the index update instructions
    - [x] Verify entries use correct link format

- [x] Task 2.3: Update metadata.json template in setup.md (FR-8) `52e2f79`
    - [x] Define acceptance criteria
    - [x] Edit `claude-skills/measure/references/setup.md` — update the metadata.json template
...
- [x] Task 2.4: Add setup guidance for memory artifacts and budget checker `52e2f79`
    - [x] Define acceptance criteria
    - [x] Edit `claude-skills/measure/references/setup.md`
    - [x] Verify the guidance is additive and clearly points to the checker script

- [ ] Task 2.5: Measure - User Manual Verification 'Phase 2: Setup Workflow Integration' (Protocol in workflow.md) — deferred
...
- [x] Task 3.1: Load lessons-learned.md before plan generation (FR-4, item 1) `b30cd9d`
    - [x] Define acceptance criteria
    - [x] Edit `claude-skills/measure/references/new-track.md` §2.3
...
- [x] Task 3.2: Surface tech debt during spec questions (FR-4, item 2) `b30cd9d`
    - [x] Define acceptance criteria
    - [x] Edit `claude-skills/measure/references/new-track.md` §2.2
...
- [x] Task 3.3: Add context-budget checks before memory files are loaded `b30cd9d`
    - [x] Define acceptance criteria
    - [x] Edit `claude-skills/measure/references/new-track.md`
...
- [x] Task 3.4: Update metadata.json template in new-track.md (FR-9) `b30cd9d`
    - [x] Define acceptance criteria
    - [x] Edit `claude-skills/measure/references/new-track.md` §2.4
...
- [ ] Task 3.6: Measure - User Manual Verification 'Phase 3: New Track Workflow Integration' (Protocol in workflow.md) — deferred
...
- [x] Task 4.1: Load project memory before execution begins `95633d5`
    - [x] Define acceptance criteria
    - [x] Edit `claude-skills/measure/references/implement.md`
...
- [x] Task 4.2: Add retrospective and metadata finalization steps to implement.md §3.4 `95633d5`
    - [x] Define acceptance criteria
    - [x] Edit `claude-skills/measure/references/implement.md` §3.4
...
- [x] Task 4.3: Add tech debt prompt and context budget note to workflow templates `95633d5`
    - [x] Define acceptance criteria
    - [x] Edit `claude-skills/measure/assets/workflow.md` and `templates/workflow.md`
    - [x] Verify both copies are identical after edit

- [ ] Task 4.4: Measure - User Manual Verification 'Phase 4: Implement Workflow Integration' (Protocol in workflow.md) — deferred
...
- [x] Task 5.1: Load recurring gotchas before analysis `b73bb15`
    - [x] Define acceptance criteria
    - [x] Edit `claude-skills/measure/references/review.md` §2.2
...
- [x] Task 5.2: Add lessons-learned logging offer to review.md §3.1 (FR-7) `b73bb15`
    - [x] Define acceptance criteria
    - [x] Edit `claude-skills/measure/references/review.md` §3.1
    - [x] Verify the prompt only triggers for Critical/High severity findings and handles absent lessons-learned.md gracefully

- [ ] Task 5.3: Measure - User Manual Verification 'Phase 5: Review Workflow Integration' (Protocol in workflow.md) — deferred
...
- [x] Task 6.1: Read status.md to understand current output format `7323d8f`
    - [x] Read `claude-skills/measure/references/status.md`
...
- [x] Task 6.2: Add Project Health section to status.md (FR-7) `7323d8f`
    - [x] Define acceptance criteria
    - [x] Edit `claude-skills/measure/references/status.md`
...
- [ ] Task 6.4: Measure - User Manual Verification 'Phase 6: Status Workflow Integration' (Protocol in workflow.md) — deferred

---

## Phase 7: Skill Documentation Synchronization

Update top-level Measure documentation so the new memory features are discoverable to agents.

- [x] Task 7.1: Update Measure skill overview and directory structure `84dfc3e`
    - [x] Define acceptance criteria
    - [x] Edit `claude-skills/measure/SKILL.md`
    - [x] Verify the changes are concise and consistent with the workflow references

- [x] Task 7.2: Update Measure skill assets section `84dfc3e`
    - [x] Define acceptance criteria
    - [x] Edit `claude-skills/measure/SKILL.md`
    - [x] Verify the new references are accurate

- [ ] Task 7.3: Measure - User Manual Verification 'Phase 7: Skill Documentation Synchronization' (Protocol in workflow.md) — deferred
