...
10. **Commit Plan Update:**
    - Stage `plan.md`.
    - Commit: `measure(plan): Mark task '<task name>' as complete`
...
3. **Manual Verification Plan:**
   ...
   1. Open `claude-skills/measure/references/implement.md`
...
5. **Create Checkpoint Commit:**
   - Commit: `measure(checkpoint): Checkpoint end of Phase <X>`
...
7. **Record Phase Checkpoint SHA:**
   ...
   - Commit: `measure(plan): Mark phase '<PHASE NAME>' as complete`
...
git add claude-skills/measure/references/implement.md
...
- `measure`: Meta/infrastructure changes
